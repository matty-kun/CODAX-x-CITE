      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {features.map((feature, index) => (
            ...
            >
              <div className="bg-gradient-to-br from-purple-500 to-blue-600 w-12 h-12 rounded-lg flex items-center justify-center mb-6">
        ...
        >
          ...
          <motion.button
            className="bg-white text-purple-600 px-8 py-4 rounded-full font-semibold text-lg shadow-lg"
