    ...
    <footer id="footer" className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 sm:px-6 py-10 sm:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            <div className="flex flex-col md:flex-row items-center md:items-start gap-3 mb-6 justify-center md:justify-start">
            ...
            <div className="space-y-3 sm:space-y-4">
              {socialLinks.map((social, index) => (
                <motion.a
                  key={index}
                  href={social.href}
                  className={`flex items-center justify-center md:justify-start gap-3 text-gray-300 ${social.color} transition-colors duration-200 text-sm sm:text-base`}
                  whileHover={{ x: 4 }}
                >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="border-t border-gray-800 mt-10 sm:mt-12 pt-6 sm:pt-8 flex flex-col md:flex-row justify-between items-center gap-4"
        >
          <p className="text-gray-400 text-center md:text-left text-xs sm:text-base mb-2 md:mb-0">
      ...
      {/* Back to Top Button */}
      <motion.button
        className="fixed bottom-4 right-4 sm:bottom-8 sm:right-8 bg-gradient-to-r from-purple-600 to-blue-600 text-white p-2 sm:p-3 rounded-full shadow-lg z-50"
